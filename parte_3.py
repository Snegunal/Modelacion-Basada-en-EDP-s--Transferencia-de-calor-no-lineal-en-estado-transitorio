...
# snegrete@unal.edu.co

# Transferencia de calor bidimensional
# en estado transitorio para un par de placas
# de una combinación de dos materiales
...
# Guardar 200 imágenes aproximadamente
...
# Crear matrices donde almacenar la posición nodal. Servirá para graficar
X,Y = np.meshgrid(x,y)
...
# resolver en el tiempo. con cada paso se debe actualizar el vector b
Tc = 470
Tf = 280
